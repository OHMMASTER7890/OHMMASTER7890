--[[MADE BY OHMMASTER7890
Discord: nah i got ban
Dont change or u can get banned !!! not my fault if U get banned
--]]
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Window  = Library.CreateLib("Script Made By OHMMASTER7890", "DarkTheme")
...
local Section = Tab:NewSection("Made By OHMMASTER7890")
local Section = Tab:NewSection("ADD ME ON DISCORD OHMMASTER7890")
